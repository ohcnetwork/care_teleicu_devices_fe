...
export default function FeedButton(props: Props) {
  const child = (
    <button
      className={cn(
        "flex size-8 items-center justify-center rounded-lg border shadow-sm transition bg-black/50 backdrop-blur-md hover:backdrop-blur-xl sm:shadow-none sm:hover:shadow sm:active:shadow-2xl md:backdrop-blur-md border-zinc-500/30 text-zinc-500 sm:border-zinc-700/50 sm:text-zinc-200 sm:hover:bg-zinc-50 sm:hover:text-zinc-800",
        props.className
      )}
      type="button"
